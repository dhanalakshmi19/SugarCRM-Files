<?php /* Smarty version 2.6.11, created on 2017-08-23 20:36:25
         compiled from install/templates/confirmSettings.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'constant', 'install/templates/confirmSettings.tpl', 190, false),array('modifier', 'realpath', 'install/templates/confirmSettings.tpl', 310, false),)), $this); ?>
...
" alt="SugarCRM" border="0"></a>
 ...
 <?php echo $this->_tpl_vars['dbCreate']; ?>
                    ...
                    <?php endif; ?>
                    <?php $_from = $this->_tpl_vars['warningsLocalhost']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['warning']):
?>
                        <tr>
                            <td></td>
                            <td colspan="2" align="center"><span class='stop'><b><?php echo $this->_tpl_vars['warning']; ?>
</b></span></td>
                        </tr>
