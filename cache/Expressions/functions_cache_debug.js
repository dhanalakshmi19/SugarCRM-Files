 ...
 */
SUGAR.FunctionMap = {
	'rollupAve'	:	SUGAR.expressions.AverageRelatedExpression,	'rollupAvg'	:	SUGAR.expressions.AverageRelatedExpression,	'strlen'	:	SUGAR.expressions.StringLengthExpression,	'ceil'	:	SUGAR.expressions.CeilingExpression,	'ceiling'	:	SUGAR.expressions.CeilingExpression,	'negate'	:	SUGAR.expressions.NegateExpression,	'min'	:	SUGAR.expressions.MinimumExpression,	'abs'	:	SUGAR.expressions.AbsoluteValueExpression,	'average'	:	SUGAR.expressions.AverageExpression,	'avg'	:	SUGAR.expressions.AverageExpression,	'floor'	:	SUGAR.expressions.FloorExpression,	'add'	:	SUGAR.expressions.AddExpression,	'currencyAdd'	:	SUGAR.expressions.AddExpression,	'rollupMin'	:	SUGAR.expressions.MinRelatedExpression,	'ln'	:	SUGAR.expressions.NaturalLogExpression,	'indexOf'	:	SUGAR.expressions.IndexOfExpression,	'log'	:	SUGAR.expressions.LogExpression,	'divide'	:	SUGAR.expressions.DivideExpression,	'currencyDivide'	:	SUGAR.expressions.DivideExpression,	'div'	:	SUGAR.expressions.DivideExpression,	'number'	:	SUGAR.expressions.ValueOfExpression,	'max'	:	SUGAR.expressions.MaximumExpression,	'round'	:	SUGAR.expressions.RoundExpression,	'count'	:	SUGAR.expressions.CountRelatedExpression,	'subtract'	:	SUGAR.expressions.SubtractExpression,	'currencySubtract'	:	SUGAR.expressions.SubtractExpression,	'sub'	:	SUGAR.expressions.SubtractExpression,	'rollupMax'	:	SUGAR.expressions.MaxRelatedExpression,	'rollupConditionalSum'	:	SUGAR.expressions.SumConditionalRelatedExpression,	'multiply'	:	SUGAR.expressions.MultiplyExpression,	'currencyMultiply'	:	SUGAR.expressions.MultiplyExpression,	'mul'	:	SUGAR.expressions.MultiplyExpression,	'countConditional'	:	SUGAR.expressions.CountConditionalRelatedExpression,	'stddev'	:	SUGAR.expressions.StandardDeviationExpression,	'pow'	:	SUGAR.expressions.PowerExpression,	'rollupSum'	:	SUGAR.expressions.SumRelatedExpression,	'rollupCurrencySum'	:	SUGAR.expressions.SumRelatedExpression,	'median'	:	SUGAR.expressions.MedianExpression,	'timestamp'	:	SUGAR.expressions.TimestampExpression,	'now'	:	SUGAR.expressions.NowExpression,	'dayofweek'	:	SUGAR.expressions.DayOfWeekExpression,	'maxRelatedDate'	:	SUGAR.expressions.MaxRelatedDateExpression,	'today'	:	SUGAR.expressions.TodayExpression,	'daysUntil'	:	SUGAR.expressions.DaysUntilExpression,	'hoursUntil'	:	SUGAR.expressions.HoursUntilExpression,	'date'	:	SUGAR.expressions.DefineDateExpression,	'monthofyear'	:	SUGAR.expressions.MonthOfYearExpression,	'addDays'	:	SUGAR.expressions.AddDaysExpression,	'sugarField'	:	SUGAR.expressions.SugarFieldExpression,	'ifElse'	:	SUGAR.expressions.ConditionExpression,	'cond'	:	SUGAR.expressions.ConditionExpression,	'related'	:	SUGAR.expressions.RelatedFieldExpression,	'valueAt'	:	SUGAR.expressions.IndexValueExpression,	'currencyRate'	:	SUGAR.expressions.CurrencyRateExpression,	'isValidTime'	:	SUGAR.expressions.IsValidTimeExpression,	'isAlphaNumeric'	:	SUGAR.expressions.IsAlphaNumericExpression,	'isAfter'	:	SUGAR.expressions.isAfterExpression,	'isInList'	:	SUGAR.expressions.IsInEnumExpression,	'isInEnum'	:	SUGAR.expressions.IsInEnumExpression,	'isNumeric'	:	SUGAR.expressions.IsNumericExpression,	'and'	:	SUGAR.expressions.AndExpression,	'doBothExist'	:	SUGAR.expressions.BinaryDependencyExpression,	'isValidDBName'	:	SUGAR.expressions.IsValidDBNameExpression,	'isBefore'	:	SUGAR.expressions.isBeforeExpression,	'greaterThan'	:	SUGAR.expressions.GreaterThanExpression,	'isForecastClosedWon'	:	SUGAR.expressions.IsForecastClosedWonExpression,	'isForecastClosed'	:	SUGAR.expressions.IsForecastClosedExpression,	'isValidPhone'	:	SUGAR.expressions.IsValidPhoneExpression,	'equal'	:	SUGAR.expressions.EqualExpression,	'isAlpha'	:	SUGAR.expressions.IsAlphaExpression,	'isValidEmail'	:	SUGAR.expressions.IsValidEmailExpression,	'not'	:	SUGAR.expressions.NotExpression,	'isForecastClosedLost'	:	SUGAR.expressions.IsForecastClosedLostExpression,	'isWithinRange'	:	SUGAR.expressions.IsInRangeExpression,	'or'	:	SUGAR.expressions.OrExpression,	'isRequiredCollection'	:	SUGAR.expressions.IsRequiredCollectionExpression,	'isValidDate'	:	SUGAR.expressions.IsValidDateExpression,	'getDropdownValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'getDDValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'translateLabel'	:	SUGAR.expressions.SugarTranslateExpression,	'translate'	:	SUGAR.expressions.SugarTranslateExpression,	'charAt'	:	SUGAR.expressions.CharacterAtExpression,	'toString'	:	SUGAR.expressions.DefineStringExpression,	'string'	:	SUGAR.expressions.DefineStringExpression,	'subStr'	:	SUGAR.expressions.SubStrExpression,	'concat'	:	SUGAR.expressions.ConcatenateExpression,	'formatName'	:	SUGAR.expressions.FormatedNameExpression,	'strToUpper'	:	SUGAR.expressions.StrToUpperExpression,	'forecastCommitStage'	:	SUGAR.expressions.ForecastCommitStageExpression,	'contains'	:	SUGAR.expressions.ContainsExpression,	'strToLower'	:	SUGAR.expressions.StrToLowerExpression,	'getDropdownKeySet'	:	SUGAR.expressions.SugarDropDownExpression,	'getDD'	:	SUGAR.expressions.SugarDropDownExpression,	'forecastSalesStages'	:	SUGAR.expressions.ForecastSalesStageExpression,	'createList'	:	SUGAR.expressions.DefineEnumExpression,	'enum'	:	SUGAR.expressions.DefineEnumExpression,	'getListWhere'	:	SUGAR.expressions.SugarListWhereExpression,	'forecastIncludedCommitStages'	:	SUGAR.expressions.ForecastIncludedCommitStagesExpression,	'getDropdownValueSet'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'getTransDD'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'hourOfDay'	:	SUGAR.expressions.HourOfDayExpression,	'time'	:	SUGAR.expressions.DefineTimeExpression};
/**
 * The function to object map that is used by the Parser
 * to parse expressions into objects.
 */
